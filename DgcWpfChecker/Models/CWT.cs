...
namespace DGC
{
    public class CWT
    {
        ...
        public string DGCv1Json { get; set; }
        ...
        {
            CBORObject cbor = CBORObject.DecodeFromBytes(coseMessage.Content);
            var cwt = new CWT();
            cwt.CoseMessage = coseMessage;

            var cborJson=cbor.ToJSONString();
